...
### Руководство по стилю коммитов
Сообщения коммитов должны соответствовать спецификации [The Conventional Commits v1.0.0](https://www.conventionalcommits.org/en/v1.0.0/).
